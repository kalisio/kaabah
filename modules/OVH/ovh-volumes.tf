resource "openstack_blockstorage_volume_v2" "manager_volume" {
  count         = "${var.provider == "OVH" ? var.manager_additional_volume_count * var.manager_instance_count : 0}"
  region        = "${var.region}"  
...
resource "openstack_blockstorage_volume_v2" "worker_volume" {
  count         = "${var.provider == "OVH" ? var.worker_additional_volume_count * var.worker_instance_count : 0}"
  region        = "${var.region}"  
