...
::: warning SSH key
*Kaabah* and *Terraform* use SSH to operate on the various nodes. Consequently you need the private key `ssh.pem` used for the connection.
These keys are generated by the providers (i.e. Scaleway and AWS)
:::
...
#### Attach and detach additional volumes
...
Check this [tutotial](https://www.scaleway.com/docs/attach-and-detach-a-volume-to-an-existing-server/) for further information.
